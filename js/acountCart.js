...
// API TOURS
const URL_ = 'https://api-tours-default-rtdb.firebaseio.com/tours.json';

let totalSum = 0, total = 0, totalCarts = [];
var cart;

if ((window.location.href === 'http://localhost/paginaTours/tours/') || (window.location.href === 'https://toursopen.netlify.app/' || window.location.href === 'https://toursopen.netlify.app/index.html' || window.location.href === 'http://localhost/paginaTours/tours/index.html' || window.location.href === 'https://touropen.com.co/')) {
